...
const STEPS = [
  {
    ...
    desc: "A free 15-minute call to find the right program for you — SAT prep or Integrated Math. We'll figure out where you are and what you need. No commitment.",
    icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 9v7.5" /></svg>,
  },
  {
    num: '02', title: 'Join Your Cohort',
    desc: "We place you in the right cohort based on your current level and goals. 3-week sessions, daily morning calls, flexible attendance — built around your schedule.",
  ...
  },
  {
    ...
    desc: 'Track your progress with regular check-ins and strategy adjustments throughout the cohort. Whether it\'s SAT scores or class grades, we help you get results.',
